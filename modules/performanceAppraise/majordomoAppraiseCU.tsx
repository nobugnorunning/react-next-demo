    ...
    <>
      <PageContainer header={{
        ...
        <div className={[styles.formCard, "mb-[20px]"].join(" ")}>
          <div
            className={[GlobalClasses.title, "title"].join(" ")}>{(isEdit && !isDetail) ? "编辑" : isAdd ? "新增" : ""}总监绩效评价考核{isDetail ? "详情" : ""}</div>
          <div className={GlobalClasses.subTitle}>--绩效基本信息--</div>
          ...
          <div className="header">
            <div className={[GlobalClasses.subTitle, 'title'].join(" ")}>--绩效明细列表--</div>
            {
              !(isAdd || isEdit) ?
                null :
                (
